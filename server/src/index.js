...
app.use(['/api/products', '/products'], productRoutes_1.default);
app.use(['/api/offers', '/offers'], offerRoutes_1.default);
app.use(['/api/orders', '/orders'], orderRoutes_1.default);
app.use(['/api/stats', '/stats'], statsRoutes_1.default);
app.use(['/api/settings', '/settings'], settingsRoutes_1.default);
